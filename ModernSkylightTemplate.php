...
?>
		...
		<div id="rsp-header" class="rsp clear">
			...
			<div id="rsp-tools" class="rsp" role="navigation">
				<ul class="rsp-menu">
					<li><a href="<?=$this->getUrl("특수기능:임의문서")?>">랜덤 읽기</a></li>
					<li><a href="<?=$this->getUrl("위키쨩:연습장")?>">연습장</a></li>
					<li><a class="r-submenu">도구</a>
						<ul class="rsp-submenu">
							<li><a href="<?=$this->getUrl("특수기능:최근바뀜")?>">모든 문서의 바뀜</a></li>
							<li><a href="<?=$this->getUrl("특수기능:주시문서목록")?>">주시 문서의 바뀜</a></li>
							<li><a href="<?=$this->getUrl("특수기능:새문서")?>">새로 등록된 문서</a></li>
							<li><a href="<?=$this->getUrl("특수기능:새파일")?>">새로 등록된 파일</a></li>
							<li><a href="<?php echo $toolList['whatlinkshere']['href']; ?>">여기를 가리키는 문서</a></li>
						</ul>
					</li>
					<?php if ($this->data['isadmin']) : ?>
					<li><a class="r-submenu">관리</a>
						<ul class="rsp-submenu">
							...
							<li><a href="<?=$this->getUrl("특수기능:일괄삭제")?>">문서 일괄 삭제</a></li>
							<li><a href="<?=$this->getUrl("특수기능:문서대량삭제")?>">문서 패턴 삭제</a></li>
							<li><a href="<?=$this->getUrl("특수기능:아바타삭제")?>">아바타 삭제하기</a></li>
							<hr>
							<li><a href="<?=$this->getUrl("특수기능:이름바꾸기")?>">계정 이름 변경</a></li>
							<li><a href="<?=$this->getUrl("특수기능:사용자병합")?>">사용자 병합</a></li>
							<li><a href="<?=$this->getUrl("특수기능:차단")?>">사용자 차단</a></li>
